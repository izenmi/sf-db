...
const BADGES = [
  { label: "作品", value: counts.works, color: "#7189e6" },
  { label: "著者", value: counts.authors, color: "#f68fbe" },
  { label: "翻訳者", value: counts.translators, color: "#8adcae" },
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .glow--1 { width: 520px; height: 520px; top: -180px; right: -140px; background: #6e8bff; }
  .glow--2 { width: 460px; height: 460px; bottom: -200px; left: -120px; background: #8ea6f0; }
  .badge {
    position: relative;
    width: 108px;
    height: 108px;
...
<body>
  ...
  <h1>SF小説DB</h1>
  <p class="tagline">国内外のSF小説を著者・翻訳者・受賞歴・テーマから探せるデータベース</p>
  <div class="stats">
    ${BADGES.map(
