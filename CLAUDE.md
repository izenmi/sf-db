...
→ **407作品**(同日、海外主要SF賞・国内新人賞・「SFが読みたい!」各年ベスト10、バッチ10〜32)。
...
| 「SFが読みたい!」各年ベスト10(上位) | 74作品 | 26〜32 |

407作品(国内190/海外217)・著者238・翻訳者78・出版社31・テーマ37・アワード12。
表紙296/407。受賞歴は576件。発表年は1951年『銀河帝国の興亡』から2026年まで。

## 未着手の候補源(次に手をつけるところ)

- **「SFが読みたい!」各年ベスト10の第4〜10位**。`python3 scripts/yomitai.py` で未登録の候補が出る
  (2026-08-11時点で347件)。出力は `st / 対象年 / 部門 / 順位 / タイトル / 著者` のTSVで、
  上位から順に潰していくのが効率がよい
- 天冥の標シリーズ、《ファージング》三部作など**シリーズ単位で表に載っている行**は個別巻の調査が必要
