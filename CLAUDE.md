...
→ **900作品**(同日、WikipediaのSF小説カテゴリに戻す、バッチ75〜82)。
...
| WikipediaのSF小説カテゴリ | 105作品 | 51〜52, 75〜82 |
| 楽天ブックスの著者検索(`byauthor.py`) | 224作品 | 53〜74 |

900作品(国内471/海外429)・著者311・翻訳者141・出版社60・テーマ37・アワード12。
...
- **未登録著者分(約230件)に、SFの主要古典がまるごと眠っていた**。賞パイプラインで作ったDBには
  ...
  『渚にて』『わたしを離さないで』などを一気に登録した。**残りにもバローズの火星シリーズ、レンズマン、
  キャプテン・フューチャー、ハンガー・ゲーム、家畜人ヤプー、魔界転生などが残っている**
