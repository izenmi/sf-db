...
→ **916作品**(同日、WikipediaのSF小説カテゴリに戻す、バッチ75〜84)。
...
| WikipediaのSF小説カテゴリ | 121作品 | 51〜52, 75〜84 |
| 楽天ブックスの著者検索(`byauthor.py`) | 224作品 | 53〜74 |

916作品(国内480/海外436)・著者322・翻訳者147・出版社62・テーマ37・アワード12。
...
- **未登録著者分(約230件)に、SFの主要古典がまるごと眠っていた**。賞パイプラインで作ったDBには
  ...
  『狂気の山脈にて』『リプレイ』なども登録した。**残りにはレンズマン、キャプテン・フューチャー、
  ハンガー・ゲーム、メイズ・ランナー、ストルガツキー兄弟、ヴェルヌとブラッドベリの残りなどがある**
