...
571作品(国内296/海外275)・著者294・翻訳者97・出版社41・テーマ37・アワード12。
表紙441/571。受賞歴は744件。発表年は1951年『銀河帝国の興亡』から2026年まで。

## 未着手の候補源(次に手をつけるところ)

- **「SFが読みたい!」各年ベスト10の残り**。`python3 scripts/yomitai.py` で未登録の候補が出る
  (2026-08-12時点で189件)。ただしこの残りには**編者アンソロジー・評論・非小説・シリーズ単位のエントリ・
  あらすじの出典がない絶版書**が多く含まれるので、実際に登録できるのは半数程度と見込まれる
- 出力は `st / 対象年 / 部門 / 順位 / タイトル / 著者` のTSV。国内篇・海外篇とも第1〜10位を
  1999年から2024年まで一巡したので、残りは各年の谷間(未登録のまま飛ばした行)を拾う作業になる
