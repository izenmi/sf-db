...
→ **779作品**(同日、楽天の著者検索を候補源に切り替え、バッチ53〜70)。
...
| 楽天ブックスの著者検索(`byauthor.py`) | 187作品 | 53〜70 |

779作品(国内408/海外371)・著者294・翻訳者119・出版社49・テーマ37・アワード12。
...
- **楽天の著者検索の残り**(`python3 scripts/byauthor.py`)。2026-08-12時点で、SF系4版元(早川/創元/
  国書/竹書房)の分は概ね消化した。**残るのは講談社・集英社・KADOKAWA・光文社・小学館などから出た分**で、
  紹介文が100字以上あるものだけで約350件。ただし非SF(歴史小説・ミステリ・エッセイ)の混入率が高いので
  1件ずつ判断が要る。特に小学館の眉村卓復刊、KADOKAWAの劉慈欣・小林泰三、光文社の上田早夕里が有望
